...
background_image = pygame.transform.scale(pygame.image.load('backgroundpng.htm').convert(),(SCREEN_WIDTH, SCREEN_HEIGHT))
penguin_image = pygame.transform.scale(pygame.image.load('penguinpng.jfif'),convert_alpha(), (200, 200))
